...
namespace ExpressionEvaluator.Operators
{
    ...
    internal class OperatorCustomExpressions
    {
        ...
        /// <param name="args">List of arguments to be passed if the member is a method, or index accessor</param>
        /// <param name="assemblyNames">list of Assemblies to be used for resolving extension methods</param>
        /// <returns></returns>
        public static Expression MemberAccess(bool isFunction, Expression le, string membername, List<Expression> args, List<string> assemblyNames)
        {
